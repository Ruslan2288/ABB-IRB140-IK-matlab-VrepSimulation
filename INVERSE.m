function q = INVERSE(xtip,ytip,ztip,alpha,beta,gama) 
...
% sel = input ('TO SOLVE THE INVERSE WITH RESPECT TO FRAME6 PRESS 1 WHILE, TO SOLVE THE INVERSE WITH RESPECT TO TCP ENTER 2: ');
% if (sel == 1)
% d6 = 0;
% elseif (sel == 2)
% d6 = 65;
...
q(4)=Solution1(1)/180*pi;
q(5)=Solution1(2)/180*pi;
q(6)=Solution1(3)/180*pi;
